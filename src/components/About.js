        ...
        <div classname="xContainer">
          <div className="row">
            <div className="col-md-12 mb-4 text-center">
              <h3 className="aboutHeading" style={{ paddingTop: "25px" }}>
                Our Team
              </h3>
              <div class="underline mx-auto"></div>
            </div>
            ...
            <div style={{ display: "flex", justifyContent: "space-evenly" }}>
              <div style={{ display: "flex", flexDirection: "column" }}>
                ...
                <img
                  ...
                  className="border-bottom image"
                  alt="Ross"
                />

                <p>Web and Design Lead.</p>
                <p>Aesthetics is life.</p>
                <p>Ultimate hype guy.</p>
              ...
              <div style={{ display: "flex", flexDirection: "column" }}>
                ...
                <p>Project and Managing Lead.</p>
                <p>Google Guru.</p>
                <p>German efficiency.</p>
                <p>Can solve any problem.</p>
                <p>Simply the best!</p>
              </div>
              ...
              <div style={{ display: "flex", flexDirection: "column" }}>
                ...
                <p>Ideas generator.</p>
                <p>Build you the best damn table.</p>
                <p>Simply the best!</p>
              </div>
            </div>
          </div>
